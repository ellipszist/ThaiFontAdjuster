...
public static class ThaiFontFix
{
    ...
    public static bool IsPC => Constants.TargetPlatform == GamePlatform.Windows;
    ...
    public static void Init()
    {
...

        {
            ...
            {
                //Work In Progress!!!
                //dont forget write this code!!
                //var method = typeof(Utility).GetMethod(nameof(Utility.drawmulti));
        ...
        }
        {
            ...
            var methodReplacement = GetMethod(IsAndroid ? nameof(PrefixSpriteTextDrawStringAndroid) : nameof(PrefixSpriteTextDrawStringPC));
    ...
    static void PrefixSpriteTextDrawStringPC(SpriteBatch b, string s, int x, int y, int characterPosition = 999999,
    ...
    static void PrefixSpriteTextDrawStringAndroid(SpriteBatch b, ref string s, int x, int y, int characterPosition = 999999,
        int width = -1, int height = 999999, float alpha = 1f, float layerDepth = 0.88f,
        bool junimoText = false, int drawBGScroll = -1, string placeHolderScrollWidthText = "",
